...
namespace Nube
{
    public static class AppLib
    {
        ...
        public enum MonthlySubscriptionMatchingType { NRICMatched=1, NRICNotMatched=2, MismatchedMemberName=3, MismatchedBank=4, MismatchedPreviousSubscription=5, StruckOffMembers=6, ResignedMembers=7, NRICOldMatched=8, NRICByBankMatched=9 };
